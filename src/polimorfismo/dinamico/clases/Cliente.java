...
public class Cliente extends Persona{
	...
	public Cliente(int id, String nombre, String apellido, String nro_cuenta
			, double saldo, String cualidades,String deudas) {
	...
	public String metodoClasePersona() {
		return "Metodo de la clase Persona Sobreescrito en clase Cliente";
	}
